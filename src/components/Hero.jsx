...
const Hero = () => {
	return (
		<div className="w-full relative h-screen mx-auto">
			...
			>
				<div
					className={`flex flex-col justify-center items-center ${animate.fadeIn} animate__delay-1s`}
				>
				...
				<div>
					<h1
						className={`${styles.heroHeadText} ${animate.fadeIn} animate__delay-1s`}
					>
						Hi, I am <span className="text-primary">Mhar Nhel</span>
					</h1>
					<p
						className={`${styles.heroSubText} ${animate.fadeIn} animate__delay-1s font-mono`}
					>
						Web Developer, I develop web applications
						<br className="sm:block hidden" /> and user interfaces.
					</p>
					<div
						className={`mt-5 p-2 bg-primary sm:w-[135px] w-[100px] rounded-[5px] mb-5 text-white cursor-pointer ${animate.fadeIn} animate__delay-1s`}
					>
						<a
							href={resume}
							download="resume.pdf"
				...
				<div>
					<Tilt
						className={`lg:block hidden ${animate.fadeIn}  animate__delay-2s `}
					>
						<div className="block w-[370px] rounded-full shadow-card shadow-primary">
							<img
								src={heropic}
								alt="heropic"
								className="hero-img rounded-full object-cover w-[370px] h-[370px] line-gradient"
							/>
						</div>
					</Tilt>
				</div>
